        ...
        <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[8] w-[95%] sm:w-[90%] laptop:w-[85%] max-w-md laptop:max-w-lg desktop:max-w-xl pointer-events-none">
            <div
                ...
                style={{
                    boxShadow: isDarkMode
                        ? "0 20px 60px rgba(0, 0, 0, 0.4), 0 0 0 1px rgba(148, 163, 184, 0.2)"
                        : "0 20px 60px rgba(0, 0, 0, 0.3), 0 0 0 1px rgba(0, 0, 0, 0.1)",
                    background: isDarkMode
                        ? "linear-gradient(180deg, rgba(51, 65, 85, 0.95) 0%, rgba(30, 41, 59, 0.95) 100%)"
            ...
            >
                ...
                <div
                    ...
                    style={{
                        background: isDarkMode
                            ? "linear-gradient(180deg, rgba(71, 85, 105, 0.8) 0%, rgba(51, 65, 85, 0.8) 100%)"
                ...
                <div className="p-4 sm:p-5 laptop:p-6 desktop:p-8 text-center space-y-3 sm:space-y-4 laptop:space-y-5 desktop:space-y-6 pointer-events-none">
                    ...
                    {/* Title */}
                    <div>
                        <h1 className="text-lg sm:text-xl laptop:text-2xl desktop:text-3xl font-bold mb-1 leading-tight transition-colors duration-300" style={{
                            color: isDarkMode ? '#f8fafc' : '#111827'
                        }}>
                            {t('finderWelcome.title')}
                        </h1>
                        <p className="text-xs sm:text-sm laptop:text-base transition-colors duration-300" style={{
                            color: isDarkMode ? '#cbd5e1' : '#6b7280'
                        }}>{t('finderWelcome.subtitle')}</p>
                    </div>
                    ...
                    <div className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm laptop:text-base">
                        <div className="flex justify-between items-center px-2 sm:px-4 laptop:px-6">
                            <span className="text-right flex-1 transition-colors duration-300" style={{
                                color: isDarkMode ? '#cbd5e1' : '#4b5563'
                            }}>{t('finderWelcome.role')}</span>
                            <span className="font-medium text-left flex-1 ml-2 sm:ml-4 transition-colors duration-300" style={{
                                color: isDarkMode ? '#f8fafc' : '#111827'
                            }}>{t('finderWelcome.roleValue')}</span>
                        </div>
                        <div className="flex justify-between items-center px-2 sm:px-4 laptop:px-6">
                            <span className="text-right flex-1 transition-colors duration-300" style={{
                                color: isDarkMode ? '#cbd5e1' : '#4b5563'
                            }}>{t('finderWelcome.experience')}</span>
                            <span className="font-medium text-left flex-1 ml-2 sm:ml-4 transition-colors duration-300" style={{
                                color: isDarkMode ? '#f8fafc' : '#111827'
                            }}>{t('finderWelcome.experienceValue')}</span>
                        </div>
                        <div className="flex justify-between items-center px-2 sm:px-4 laptop:px-6">
                            <span className="text-right flex-1 transition-colors duration-300" style={{
                                color: isDarkMode ? '#cbd5e1' : '#4b5563'
                            }}>{t('finderWelcome.status')}</span>
                            <span className="font-medium text-left flex-1 ml-2 sm:ml-4 transition-colors duration-300" style={{
                                color: isDarkMode ? '#f8fafc' : '#111827'
                            }}>{t('finderWelcome.statusValue')}</span>
                        </div>
                        <div className="flex justify-between items-center px-2 sm:px-4 laptop:px-6">
                            <span className="text-right flex-1 transition-colors duration-300" style={{
                                color: isDarkMode ? '#cbd5e1' : '#4b5563'
                            }}>{t('finderWelcome.version')}</span>
                            <span className="font-medium text-left flex-1 ml-2 sm:ml-4 transition-colors duration-300" style={{
                                color: isDarkMode ? '#f8fafc' : '#111827'
                            }}>{t('finderWelcome.versionValue')}</span>
                        </div>
                    </div>
                    ...
                    <div className="pt-1 sm:pt-2 laptop:pt-3 pointer-events-auto space-y-2 sm:space-y-3">
                        ...
                        >
                            ...
                            {/* label */}
                            {isDarkMode ? (
                                <Sun className="w-3 h-3 sm:w-3.5 sm:h-3.5 relative z-10" />
                            ) : (
                                <Moon className="w-3 h-3 sm:w-3.5 sm:h-3.5 relative z-10" />
                            )}
                            <span className="relative z-10">
                    ...
                    <div className="pt-2 sm:pt-3 laptop:pt-4 space-y-0.5 sm:space-y-1">
                        <p className="text-[10px] sm:text-xs laptop:text-sm transition-colors duration-300" style={{
                            color: isDarkMode ? '#cbd5e1' : '#6b7280'
                        }}>{t('finderWelcome.footer1')}</p>
                        <p className="text-[10px] sm:text-xs laptop:text-sm transition-colors duration-300" style={{
                            color: isDarkMode ? '#94a3b8' : '#9ca3af'
                        }}>{t('finderWelcome.footer2')}</p>
                    </div>
                </div>
            </div>
        </div>
