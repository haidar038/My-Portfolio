  ...
  return (
    <div className="space-y-6">
      ...
      <div className="prose prose-sm max-w-none">
        ...
        <div className="mt-6 p-4 rounded-lg border transition-all duration-300" style={{
          background: isDarkMode
            ? 'linear-gradient(to bottom right, rgba(14, 116, 144, 0.15), rgba(59, 130, 246, 0.15))'
          ...
          <h3 className="text-sm font-semibold mb-2 transition-colors duration-300" style={{
            color: isDarkMode ? '#67e8f9' : '#164e63'
          }}>{t('home.gettingStartedTitle')}</h3>
          <ul className="text-sm space-y-1 list-disc list-inside transition-colors duration-300" style={{
            color: isDarkMode ? '#e2e8f0' : '#374151'
          }}>
            <li>{t('home.tip1')}</li>
            <li>{t('home.tip2')}</li>
