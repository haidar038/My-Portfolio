...
import HDRBlackLogo from "@/assets/logos/hdr-dark.svg";
import HDRWhiteLogo from "@/assets/logos/hdr-white.svg";
...
export const MenuBar = () => {
    ...
    const formatTime = (date: Date) => {
        return date.toLocaleTimeString(i18n.language === "id" ? "id-ID" : "en-US", {
            weekday: "short",
            month: "short",
            day: "numeric",
            hour: "numeric",
    ...
    return (
        <div
            ...
            style={{
                background: isDarkMode ? "linear-gradient(180deg, rgba(51, 65, 85, 0.9) 0%, rgba(30, 41, 59, 0.9) 100%)" : "linear-gradient(180deg, rgba(230, 230, 230, 0.95) 0%, rgba(210, 210, 210, 0.95) 100%)",
                backdropFilter: "blur(20px)",
                WebkitBackdropFilter: "blur(20px)",
                borderBottom: isDarkMode ? "1px solid rgba(148, 163, 184, 0.3)" : "1px solid rgba(0, 0, 0, 0.2)",
                boxShadow: isDarkMode ? "0 1px 0 rgba(0, 0, 0, 0.3), inset 0 1px 0 rgba(148, 163, 184, 0.2)" : "0 1px 0 rgba(255, 255, 255, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.8)",
            }}
        >
            ...
            <div className="flex items-center gap-0">
                <button
                    ...
                    className={`h-6 px-2 flex items-center justify-center transition-colors ${activeMenu === "apple" ? "bg-blue-500/40" : "hover:bg-blue-500/30"}`}
                    onClick={() => handleMenuClick("apple")}
                >
                    <img src={isDarkMode ? HDRWhiteLogo : HDRBlackLogo} alt="HDR Logo" className="w-4 h-4 object-contain" />
                </button>
                ...
                {menus.map((menu) => (
                    <button
                        ...
                        className={`h-6 px-2 text-xs font-semibold transition-colors ${activeMenu === menu.id ? "bg-blue-500/40" : "hover:bg-blue-500/30"}`}
            ...
            <div className="flex items-center gap-2">
                <button name="Search" aria-label="Search" className="h-6 w-6 flex items-center justify-center hover:bg-blue-500/30 transition-colors rounded">
                ...
                <div className="relative">
                    <button
                        ...
                        className={`h-6 px-2 flex items-center justify-center gap-1 transition-colors rounded ${activeMenu === "language" ? "bg-blue-500/40" : "hover:bg-blue-500/30"}`}
                ...
                <button name="Battery" aria-label="Battery" className="h-6 w-6 flex items-center justify-center hover:bg-blue-500/30 transition-colors rounded">
                    <Battery className="w-3.5 h-3.5" style={{ color: isDarkMode ? "#f1f5f9" : "#1f2937" }} />
                </button>
                <button name="Wifi" aria-label="Wifi" className="h-6 w-6 flex items-center justify-center hover:bg-blue-500/30 transition-colors rounded">
                    <Wifi className="w-3.5 h-3.5" style={{ color: isDarkMode ? "#f1f5f9" : "#1f2937" }} />
                </button>
                <button name="Volume" aria-label="Volume" className="h-6 w-6 flex items-center justify-center hover:bg-blue-500/30 transition-colors rounded">
                    <Volume2 className="w-3.5 h-3.5" style={{ color: isDarkMode ? "#f1f5f9" : "#1f2937" }} />
                </button>

                {/* Dark Mode Toggle */}
                <button className="h-6 w-6 flex items-center justify-center hover:bg-blue-500/30 transition-colors rounded" onClick={toggleTheme} title={isDarkMode ? "Switch to Light Mode" : "Switch to Dark Mode"}>
                    {isDarkMode ? <Sun className="w-3.5 h-3.5" style={{ color: "#fbbf24" }} /> : <Moon className="w-3.5 h-3.5" style={{ color: "#1f2937" }} />}
                </button>
